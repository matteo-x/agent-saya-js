...
export class TwitterPostClient {
    ...
    async sendStandardTweet(
        ...
        try {
            const standardTweetResult = await this.sendTweet(content, tweetId);
    ...
    sendTweet(content: string, tweetId?: string) {
        return this.client.requestQueue.add(
            async () =>
                await this.client.twitterClient.sendTweet(content, tweetId)
        );
    }
